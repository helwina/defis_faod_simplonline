...
class PersonnesControllerTest < ActionController::TestCase
  ...
  test "should create personne" do
    assert_difference('Personne.count') do
      post :create, personne: { date_de_naissance: @personne.date_de_naissance, nom: @personne.nom, prenomb: @personne.prenomb }
    end
  ...
  test "should update personne" do
    patch :update, id: @personne, personne: { date_de_naissance: @personne.date_de_naissance, nom: @personne.nom, prenomb: @personne.prenomb }
    assert_redirected_to personne_path(assigns(:personne))
  end
